...
namespace icFlow
{
    ...
    {
        public const int Parts = 1024*32; // initial time is split into 1024 intervals
        ...
        // scale for principal stresses
        [Category("StressStrain")]
        public double PrincipalStress1Max { get; set; }
        [Category("StressStrain")]
        public double PrincipalStress1Min { get; set; }
        [Category("StressStrain")]
        public double PrincipalStress2Max { get; set; }
        [Category("StressStrain")]
        public double PrincipalStress2Min { get; set; }
        [Category("StressStrain")]
        public double PrincipalStress3Max { get; set; }
        [Category("StressStrain")]
        public double PrincipalStress3Min { get; set; }
        #endregion
        ...
        public class FrameSummary
        {
            ...
            public FrameSummary(List<FrameInfo> frames, ModelPrms prms)
            {
                string Name = prms.name;
                double GrainSize = prms.GrainSize;
                ...
                FlexuralStrength = prms.FlexuralStrength(MaxForce);
