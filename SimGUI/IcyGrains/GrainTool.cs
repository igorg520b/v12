...
Extrude {0, indsize, 0} {
  Surface{1}; 
        ...
        public void LBeamGeneration(BeamParams prms)
        {
            ...
            sw.WriteLine($"Point(2) = {{ dx + l2, dy + 0, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(22) = {{ dx + l2 / 2,dy + 0, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(3) = {{ dx + l2, dy - a, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(4) = {{ dx + 0,dy - l1 + c / 2, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(5) = {{ dx - c,dy - l1 + c / 2, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(6) = {{ dx - c / 2,dy - l1 + c / 2, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(7) = {{ dx - c, dy + c, 0, 1.0}};");
            sw.WriteLine(@"Point(8) = { dx + l2 + c, dy + c, 0, 1.0};");
            sw.WriteLine(@"Point(9) = { dx + l2 + c, dy - a - c, 0, 1.0};");
            sw.WriteLine($"Point(10) = {{ dx + b + 2 * c,dy - a, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(11) = {{ dx + b,dy - a - 2 * c, 0, {prms.RefinementMultiplier}}};");
            ...
            sw.WriteLine($"Point(15) = {{ dx + b,dy - l1 + c / 2, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(16) = {{ dx + b + c,dy - l1 + c / 2, 0, {prms.RefinementMultiplier}}};");
            sw.WriteLine($"Point(17) = {{ dx + b + c / 2,dy - l1 + c / 2, 0, {prms.RefinementMultiplier}}};");
...
");
            ...
            sw.WriteLine($"Point(23) = {{  dx/4 + l2/4 + c/4 + d/4, -d , 0, {prms.RefinementMultiplier}}};");
