    ...
    public partial class Form1 : Form
    {
        ...
        private void setupGenerationToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            using (IcyGrains.SetupGeneratorForm sgf = new IcyGrains.SetupGeneratorForm())
            {
                ...
                {
                    model3.Clear();
                    tssStatus.Text = "setting up simulation";
                    Mesh mg = new Mesh(sgf.memStr, sgf.rprm.name, ".msh");
                    Mesh mgIndenter = new Mesh(sgf.memStrIndenter, "indenter", ".msh");
                    ...
                    model3.prms.name = sgf.rprm.name;
