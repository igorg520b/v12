...
namespace icFlow.Rendering
{
    public class RenderPrms
    {
        ...
        [Category("Surface")]
        public bool UseGrainColor { get; set; } = true;
        ...
        [Category("Rigid")]
        [XmlIgnore]
        public Color RigidObjectColor { get; set; } = Color.FromArgb(190,175,124);
        ...
        [Category("Perspective")]
        public double zOffset { get; set; } = 9;
        ...
        [Category("Overlay")]
        public bool RenderPlot { get; set; } = false;
        ...
        #region view modes / stress
        public enum ViewMode { Model, Stress };
        [Category("Stress")]
        public ViewMode viewMode { get; set; } = ViewMode.Model;

        public enum StressType { FirstP, XX }

        [Category("Stress")]
        public StressType WhichStress { get; set; } = StressType.FirstP;

        [Category("Stress")]
        public int Palette { get; set; } = 6;
